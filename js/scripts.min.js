...
$(function () {
    ...
    var mobileClasss = function mobileClasss() {
        ...
        return [refineryMb, usMb, bazaarMb, nylonMb, coveteurMb, mclairMb];
    };
    ...
    $window.resize(function resize() {
        ...
        refinery.removeClass('col-xs-2'), us.removeClass('col-xs-4'), bazaar.removeClass('col-xs-6'), nylon.removeClass('col-xs-6'), coveteur.removeClass('col-xs-6'), mclair.removeClass('col-xs-12');
    }).trigger('resize');
});